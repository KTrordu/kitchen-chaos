...
public class Player : NetworkBehaviour, IKitchenObjectParent
{
    ...
    private void HandleMovement()
    {
        ...
        if (!canMove)
        {
            ...
            canMove = (moveDir.x < -0.5 || moveDir.x > 0.5) && !Physics.BoxCast(transform.position, Vector3.one * playerRadius,
            ...
            else
            {
                ...
                canMove = (moveDir.z < -0.5 || moveDir.z > 0.5) && !Physics.BoxCast(transform.position, Vector3.one * playerRadius,
